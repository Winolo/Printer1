...
import com.example.acer.printer.Getrating;
...
public class Productlistadapter extends RecyclerView.Adapter<Productlistadapter.ProductViewholder> {
    ...
    public void onBindViewHolder(@NonNull final ProductViewholder productViewholder, int position) {
       ...
       if(product.getStatus().contains("true")){
           productViewholder.Qrcode.setVisibility(View.INVISIBLE);
           productViewholder.recieve.setVisibility(View.INVISIBLE);
       }
       else{
           productViewholder.Qrcode.setVisibility(View.VISIBLE);
           productViewholder.recieve.setVisibility(View.VISIBLE);
       }
        ...
        productViewholder.recieve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent go=new Intent(mCtx,Getrating.class);
