...
public class LoginActivity extends AppCompatActivity {
    ...
    public void Loginuser() {
        ...
        Call<ResponseBody> call1=RetrofitClient.getInstance().getApi().adminlogin(Username.getText().toString(),Password.getText().toString());
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    if(res.equals("success")) {
                        Intent Goactivities=new Intent(LoginActivity.this,Adminactivities.class);
