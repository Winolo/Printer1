...
public class memberActivities2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_activities2);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(memberActivities2.this));

        Call<Productresponse> call=RetrofitClient.getInstance().getApi().getallproduct2();

        call.enqueue(new Callback<Productresponse>() {
            @Override
            public void onResponse(Call<Productresponse> call, Response<Productresponse> response) {
                productList=response.body().getProductList();
                productadapter=new Productadapter(memberActivities2.this,productList);
